import { Component, OnInit } from '@angular/core';
 ...
 export class StudentListComponent implements OnInit {
	 ...
	 constructor(private studentService:StudentService,private studentsService:StudentsService,private toastr: ToastrService) { }
 	...
 	deleteStudent(index:number){
 		...
 		if (r == true) {
 			let studentDelete = this.studentsService.deleteStudent(index);
 			if(studentDelete) {
